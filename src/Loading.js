...
class Loading extends React.Component {
    render() {
        return (
            <div id="loading">
                <div className="scene">
                    <svg version="1.1" id="dc-spinner" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" style={{ width: "75%", height: "75%", paddingLeft: '40vh' }} viewBox="0 0 38 38" preserveAspectRatio="xMinYMin meet">
